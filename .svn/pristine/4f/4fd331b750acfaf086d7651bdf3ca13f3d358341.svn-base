...
package info.ericyue.es.zxing.client.android.book;
...
import info.ericyue.es.zxing.client.android.AndroidHttpClient;
import info.ericyue.es.R;
import info.ericyue.es.zxing.client.android.Intents;
import info.ericyue.es.zxing.client.android.LocaleManager;
